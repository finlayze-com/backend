"""create vw_option_live_enriched

Revision ID: 3a40915215e2
Revises: 436380f82d45
Create Date: 2026-03-21 10:36:48.752365
...
revision: str = '3a40915215e2'
down_revision: Union[str, Sequence[str], None] = '436380f82d45'
...
def upgrade():
    ...
    LEFT JOIN latest_live opt_live
        REPLACE(REPLACE(TRIM(opt_live."Ticker"), 'ي', 'ی'), 'ك', 'ک')
        =
        REPLACE(REPLACE(TRIM(od.stock_ticker), 'ي', 'ی'), 'ك', 'ک')    LEFT JOIN latest_ob opt_ob
        ON opt_ob."Symbol" = od.stock_ticker
    LEFT JOIN latest_live und_live
        ON und_live."Ticker" = od.underlying_ticker
    LEFT JOIN latest_ob und_ob
        ON und_ob."Symbol" = od.underlying_ticker
