...
# --- برای هر ابزار، یک جدول با همان ستون‌های مشترک ---
# مثال‌ها: سه تا ابزار + می‌تونی برای بقیه با همین الگو اضافه کنی

class HaghighiStock(Base, _ClientTypeMixin):
    """
    داده‌های حقیقی/حقوقی برای ابزار «سهام»
    """
    __tablename__ = "haghighi_stock"
    __table_args__ = (
        PrimaryKeyConstraint('symbol', 'recdate', name='haghighi_stock_pk'),
        UniqueConstraint('symbol', 'recdate', name='haghighi_stock_symbol_recdate_uq'),
    )

class HaghighiRightsIssue(Base, _ClientTypeMixin):
    """
    داده‌های حقیقی/حقوقی برای ابزار «حق‌تقدم»
    """
    __tablename__ = "haghighi_rights_issue"
    __table_args__ = (
        PrimaryKeyConstraint('symbol', 'recdate', name='haghighi_rights_issue_pk'),
        UniqueConstraint('symbol', 'recdate', name='haghighi_rights_issue_symbol_recdate_uq'),
    )

class HaghighiFundGold(Base, _ClientTypeMixin):
    """
    داده‌های حقیقی/حقوقی برای ابزار «صندوق طلا»
    """
    __tablename__ = "haghighi_fund_gold"
    __table_args__ = (
        PrimaryKeyConstraint('symbol', 'recdate', name='haghighi_fund_gold_pk'),
        UniqueConstraint('symbol', 'recdate', name='haghighi_fund_gold_symbol_recdate_uq'),
    )

# به همین شکل می‌تونی اضافه کنی:
# HaghighiFundStock (haghighi_fund_stock)
# HaghighiFundSegment (haghighi_fund_segment)
# HaghighiFundBalanced (haghighi_fund_balanced)
# HaghighiFundFixincome (haghighi_fund_fixincome)
# HaghighiFundIndexStock (haghighi_fund_index_stock)
# HaghighiFundLeverage (haghighi_fund_leverage)
# HaghighiFundZafran (haghighi_fund_zafran)
# HaghighiFundOther (haghighi_fund_other)
# HaghighiBond (haghighi_bond)
# HaghighiOption (haghighi_option)
# HaghighiCommodity (haghighi_commodity)
